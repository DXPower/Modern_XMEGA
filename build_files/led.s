	...
	.globl	_Z9init_ledsv           ; -- Begin function _Z9init_ledsv
	.p2align	1
	.type	_Z9init_ledsv,@function
_Z9init_ledsv:                          ; @_Z9init_ledsv
.Lfunc_begin0:
; %bb.0:
	ldi	r24, 16
.Ltmp0:
...
.Ltmp1:
.Lfunc_end0:
	.size	_Z9init_ledsv, .Lfunc_end0-_Z9init_ledsv
                                        ; -- End function
...
.Linfo_string1:
	.asciz	"src/led.cpp"           ; string offset=39
.Linfo_string2:
	.asciz	"/mnt/c/Users/myaka/Documents/GitHub/AVR" ; string offset=51
.Linfo_string3:
	.asciz	"DIR"                   ; string offset=91
.Linfo_string4:
	.asciz	"unsigned char"         ; string offset=95
.Linfo_string5:
	.asciz	"uint8_t"               ; string offset=109
.Linfo_string6:
	.asciz	"register8_t"           ; string offset=117
.Linfo_string7:
	.asciz	"DIRSET"                ; string offset=129
.Linfo_string8:
	.asciz	"DIRCLR"                ; string offset=136
.Linfo_string9:
	.asciz	"DIRTGL"                ; string offset=143
.Linfo_string10:
	.asciz	"OUT"                   ; string offset=150
.Linfo_string11:
	.asciz	"OUTSET"                ; string offset=154
.Linfo_string12:
	.asciz	"OUTCLR"                ; string offset=161
.Linfo_string13:
	.asciz	"OUTTGL"                ; string offset=168
.Linfo_string14:
	.asciz	"IN"                    ; string offset=175
.Linfo_string15:
	.asciz	"INTCTRL"               ; string offset=178
.Linfo_string16:
	.asciz	"INT0MASK"              ; string offset=186
.Linfo_string17:
	.asciz	"INT1MASK"              ; string offset=195
.Linfo_string18:
	.asciz	"INTFLAGS"              ; string offset=204
.Linfo_string19:
	.asciz	"reserved_0x0D"         ; string offset=213
.Linfo_string20:
	.asciz	"REMAP"                 ; string offset=227
.Linfo_string21:
	.asciz	"reserved_0x0F"         ; string offset=233
.Linfo_string22:
	.asciz	"PIN0CTRL"              ; string offset=247
.Linfo_string23:
	.asciz	"PIN1CTRL"              ; string offset=256
.Linfo_string24:
	.asciz	"PIN2CTRL"              ; string offset=265
.Linfo_string25:
	.asciz	"PIN3CTRL"              ; string offset=274
.Linfo_string26:
	.asciz	"PIN4CTRL"              ; string offset=283
.Linfo_string27:
	.asciz	"PIN5CTRL"              ; string offset=292
.Linfo_string28:
	.asciz	"PIN6CTRL"              ; string offset=301
.Linfo_string29:
	.asciz	"PIN7CTRL"              ; string offset=310
.Linfo_string30:
	.asciz	"PORT_struct"           ; string offset=319
.Linfo_string31:
	.asciz	"PORT_t"                ; string offset=331
.Linfo_string32:
	.asciz	"_Z9init_ledsv"         ; string offset=338
.Linfo_string33:
	.asciz	"init_leds"             ; string offset=352
...
.Ldebug_info_start0:
	...
	.byte	4                       ; Abbrev [4] 0x35:0x143 DW_TAG_structure_type
	...
	.byte	6                       ; Abbrev [6] 0x178:0xb DW_TAG_typedef
	.long	387                     ; DW_AT_type
	.long	.Linfo_string6          ; DW_AT_name
	.byte	2                       ; DW_AT_decl_file
	.byte	84                      ; DW_AT_decl_line
	.byte	7                       ; Abbrev [7] 0x183:0x5 DW_TAG_volatile_type
	.long	392                     ; DW_AT_type
	.byte	6                       ; Abbrev [6] 0x188:0xb DW_TAG_typedef
	.long	403                     ; DW_AT_type
	.long	.Linfo_string5          ; DW_AT_name
	.byte	1                       ; DW_AT_decl_file
	.byte	126                     ; DW_AT_decl_line
	.byte	8                       ; Abbrev [8] 0x193:0x7 DW_TAG_base_type
	.long	.Linfo_string4          ; DW_AT_name
	.byte	8                       ; DW_AT_encoding
	.byte	1                       ; DW_AT_byte_size
	.byte	9                       ; Abbrev [9] 0x19a:0x14 DW_TAG_subprogram
	.short	.Lfunc_begin0           ; DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0 ; DW_AT_high_pc
