...
COMPILE_FLAGS = -O0 -g2 -mmcu=atxmega128a1u -Wall -funsigned-char -funsigned-bitfields -ffunction-sections -fdata-sections -fpack-struct -fshort-enums
COMPILE_C_FLAGS = -x c 
...
./build_files/%.s: src/%.c
	...
	clang-10 -c -I./include -MT $@ -MMD -MP -MF build_files/$*.d --target=avr -S -o "$@" "$<" 
...
bin: $(OBJ_FILES)
	...
	"C:\Program Files (x86)\Atmel\Studio\7.0\toolchain\avr8\avr8-gnu-toolchain\bin\avr-gcc.exe" -o $(OUTPUT_ELF) $(OBJ_FILES) $(USER_OBJS) -Wl,-Map="$(OUTPUT_MAP)" -Wl,--start-group -Wl,-lm  -Wl,--end-group -Wl,--gc-sections -mmcu=atxmega128a1u -B "C:\Program Files (x86)\Atmel\Studio\7.0\Packs\atmel\XMEGAA_DFP\1.1.68\gcc\dev\atxmega128a1u"  
